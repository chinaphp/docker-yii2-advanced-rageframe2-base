...
RUN cd /app && composer config --global --auth github-oauth.github.com 3fd3cd98adefa532d07ba1e03ed59d34178d8bdf && composer config repo.packagist composer https://packagist.laravel-china.org  && composer install
